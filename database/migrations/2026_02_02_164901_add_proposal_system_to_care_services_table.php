...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (DB::getDriverName() === 'mysql') {
            DB::statement("ALTER TABLE care_services MODIFY COLUMN status ENUM('pending', 'confirmed', 'completed', 'cancelled', 'no_show', 'proposed') DEFAULT 'pending'");
        }
    ...
    public function down(): void
    {
        ...
        // Revert status ENUM
        if (DB::getDriverName() === 'mysql') {
            DB::statement("ALTER TABLE care_services MODIFY COLUMN status ENUM('pending', 'confirmed', 'completed', 'cancelled', 'no_show') DEFAULT 'pending'");
        }
    }
};
