...
class PastoralCareStatisticsService
{
    /**
     ...
     */
    protected function getTimeSlotsWithStatus(PastorAvailability $availability, int $pastorId): array
    {
        ...
        $existingAppointments = PastoralCare::query()
            ->where('pastor_id', $pastorId)
