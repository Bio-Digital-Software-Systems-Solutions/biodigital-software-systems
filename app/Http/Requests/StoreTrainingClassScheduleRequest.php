...
class StoreTrainingClassScheduleRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'training_class_id.required' => 'La classe de formation est requise.',
            'training_class_id.exists' => 'La classe de formation sélectionnée n\'existe pas.',
