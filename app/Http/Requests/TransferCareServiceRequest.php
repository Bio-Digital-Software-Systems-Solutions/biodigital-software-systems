...
class TransferCareServiceRequest extends FormRequest
{
    /**
    ...
    {
        return $this->user()->can('transfer care service');
    }
    ...
    public function rules(): array
    {
        ...
        $currentPastorId = $careService instanceof CareService ? $careService->pastor_id : null;
