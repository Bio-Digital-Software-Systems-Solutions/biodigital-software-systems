...
class CareServiceAvailabilityController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $availabilities = CareServiceAvailability::where('pastor_id', $user->id)
            ->orderBy('type')
            ->orderBy('day_of_week')
        ...
        return Inertia::render('CareService/Availability/Index', [
    ...
    public function create()
    {
        ...
        return Inertia::render('CareService/Availability/Create', [
            'pastor' => $user,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $conflictQuery = CareServiceAvailability::where('pastor_id', $user->id)
        ...
        CareServiceAvailability::create($validated);

        return redirect()->route('care-service-availability.index')
     ...
     */
    public function show(CareServiceAvailability $availability)
    {
        $user = Auth::user();
        ...
        return Inertia::render('CareService/Availability/Show', [
     ...
     */
    public function edit(CareServiceAvailability $availability)
    {
        $user = Auth::user();
        ...
        return Inertia::render('CareService/Availability/Edit', [
            'availability' => $availability,
        ]);
    }
     ...
     */
    public function update(Request $request, CareServiceAvailability $availability)
    {
        $user = Auth::user();
        ...
        \Log::info('Updating care service availability', [
            'availability_id' => $availability->id,
     ...
     */
    public function destroy(CareServiceAvailability $availability)
    {
        $user = Auth::user();
     ...
     */
    public function toggleStatus(CareServiceAvailability $availability)
    {
        $user = Auth::user();
    ...
    public function previewSlots(Request $request)
    {
        try {
            ...
            $tempAvailability = new CareServiceAvailability([
