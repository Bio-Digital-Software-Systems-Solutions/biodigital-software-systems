...
class CareServiceAppointmentsTest extends TestCase
{
    ...
    public function pastor_can_confirm_appointment(): void
    {
        ...
        $response = $this->actingAs($pastor)
            ->post("/care-service/appointments/{$appointment->uuid}/confirm");
    ...
    public function pastor_can_complete_appointment(): void
    {
        ...
        $response = $this->actingAs($pastor)
            ->post("/care-service/appointments/{$appointment->uuid}/complete", [
    ...
    public function pastor_can_mark_appointment_as_no_show(): void
    {
        ...
        $response = $this->actingAs($pastor)
            ->post("/care-service/appointments/{$appointment->uuid}/no-show");
    ...
    public function appointment_api_filters_by_pastor(): void
    {
        ...
        $appointment1 = CareService::create([
            'pastor_id' => $pastor1->id,
            'appointment_date' => Carbon::tomorrow(),
            'appointment_time' => Carbon::tomorrow()->setTime(10, 0),
            'duration_minutes' => 60,
        ...
        $response = $this->actingAs($pastor1, 'sanctum')
            ->getJson('/api/care-service/appointments');
