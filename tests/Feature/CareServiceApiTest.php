...
class CareServiceApiTest extends TestCase
{
    ...
    public function it_can_get_available_time_slots(): void
    {
        ...
        $response = $this->getJson("/api/care-service/available-slots?pastor_id={$this->pastor->id}&date={$tomorrow}&duration=60");
    ...
    public function it_can_create_new_appointment(): void
    {
        ...
        $response = $this->postJson('/api/care-service/appointments', $appointmentData);
    ...
    public function it_can_complete_appointment(): void
    {
        ...
        $response = $this->postJson("/api/care-service/appointments/{$this->appointment->uuid}/complete");
    ...
    public function it_can_mark_appointment_as_no_show(): void
    {
        ...
        $response = $this->postJson("/api/care-service/appointments/{$this->appointment->uuid}/no-show");
    ...
    public function it_can_update_pastor_notes(): void
    {
        ...
        $response = $this->patchJson("/api/care-service/appointments/{$this->appointment->uuid}", [
    ...
    public function it_validates_appointment_creation_data(): void
    {
        ...
        $response = $this->postJson('/api/care-service/appointments', $invalidData);
    ...
    {
        $response = $this->getJson('/api/care-service/appointments/non-existent-uuid');
    ...
    {
        $themes = CareServiceTheme::take(1)->pluck('id')->toArray();
        ...
        $response = $this->postJson('/api/care-service/appointments', $conflictingData);
    ...
    public function it_filters_appointments_by_status(): void
    {
        ...
        $response = $this->getJson('/api/care-service/appointments?status=pending');
    ...
    public function it_can_delete_appointment_as_pastor(): void
    {
        ...
        $response = $this->deleteJson("/api/care-service/appointments/{$this->appointment->uuid}");
        ...
        $this->assertSoftDeleted('care_services', [
