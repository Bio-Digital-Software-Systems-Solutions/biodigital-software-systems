...
class CareServiceFollowUpTest extends TestCase
{
    ...
    protected CareService $appointment;
    ...
    public function parent_appointment_is_accessible_via_relationship(): void
    {
        ...
        $followUp = CareService::factory()->create([
            'pastor_id' => $this->pastor->id,
            'parent_id' => $this->appointment->id,
        ...
        $loadedFollowUp = CareService::with('parent.pastor')->find($followUp->id);
    ...
    public function follow_ups_are_accessible_via_relationship(): void
    {
        ...
        $followUp1 = CareService::factory()->create([
            'pastor_id' => $this->pastor->id,
            'parent_id' => $this->appointment->id,
            'client_name' => $this->appointment->client_name,
            'client_email' => $this->appointment->client_email,
        ...
        $followUp2 = CareService::factory()->create([
            'pastor_id' => $this->pastor->id,
            'parent_id' => $this->appointment->id,
            'client_name' => $this->appointment->client_name,
            'client_email' => $this->appointment->client_email,
        ...
        $loadedParent = CareService::with('followUps.pastor')->find($this->appointment->id);
