...
describe('TelegramMessage', function () {
    ...
    it('creates message using static method', function () {
    ...
    it('sets content using fluent method', function () {
    ...
    it('appends lines to content', function () {
        $message = TelegramMessage::create()
            ->line('Line 1')
            ->line('Line 2');
    ...
    it('defaults to HTML parse mode', function () {
        $message = TelegramMessage::create();
    ...
    it('can set markdown parse mode', function () {
    ...
    it('can set markdownV2 parse mode', function () {
    ...
    it('disables web page preview by default', function () {
        $message = TelegramMessage::create();
        $options = $message->getOptions();
    ...
    it('can enable web page preview', function () {
    ...
    it('can set reply to message id', function () {
    ...
    it('does not include reply_to_message_id when not set', function () {
        $message = TelegramMessage::create();
        $options = $message->getOptions();
