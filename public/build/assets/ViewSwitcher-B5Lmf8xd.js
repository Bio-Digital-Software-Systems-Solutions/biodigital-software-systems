<<<<<<<< HEAD:public/build/assets/ViewSwitcher-P49ofGUD.js
import{j as r}from"./app-BRMhlVrd.js";import{F as t}from"./Squares2X2Icon-DuID5BQ1.js";import{F as o}from"./ListBulletIcon-ByIM_dov.js";import{F as i}from"./CalendarDaysIcon-CnKr85Kt.js";function x({currentView:e,onViewChange:s,showCalendar:a=!1}){return r.jsxs("div",{className:"inline-flex rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 p-0.5 sm:p-1 flex-shrink-0",children:[r.jsx("button",{onClick:()=>s("grid"),className:`
========
import{j as r}from"./app-DO1w511u.js";import{F as t}from"./Squares2X2Icon-EYV2vA0_.js";import{F as o}from"./ListBulletIcon-Bebv5dNT.js";import{F as i}from"./CalendarDaysIcon-MpQUkBAN.js";function x({currentView:e,onViewChange:s,showCalendar:a=!1}){return r.jsxs("div",{className:"inline-flex rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 p-0.5 sm:p-1 flex-shrink-0",children:[r.jsx("button",{onClick:()=>s("grid"),className:`
>>>>>>>> main:public/build/assets/ViewSwitcher-B5Lmf8xd.js
