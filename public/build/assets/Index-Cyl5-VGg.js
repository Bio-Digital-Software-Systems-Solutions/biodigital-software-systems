import{R as x,j as e,H as g,L as s,a as n}from"./app-CcWhXGGT.js";import{D as h}from"./DashboardLayout-C_jxZKyO.js";import{t}from"./index-BJ_Bzfqn.js";import{D as f}from"./delete-confirmation-dialog-DzZWzfhW.js";import{F as l}from"./PlusIcon-X8HKxB1l.js";import{F as b}from"./PlayIcon-Dbw7z6mc.js";import{F as y}from"./EyeIcon-ZIXuRnjf.js";import{F as v}from"./PencilIcon-bvd3j7x7.js";import{F as j}from"./DocumentDuplicateIcon-BF_Nj--b.js";import{F as k}from"./TrashIcon-qPZHumeF.js";import"./transition-BkTBRBm9.js";import"./ChevronDownIcon-B07g8dKS.js";import"./UserGroupIcon-D8ucfYip.js";import"./index-ELEGqYP7.js";import"./toaster-CFDYnLI5.js";import"./logger-BM3S30lt.js";import"./dialog-Ck-8X2qt.js";import"./button-CceDgeMg.js";import"./utils-BAOgSzd2.js";import"./badge-Q4KH3-xf.js";import"./shield-alert-BCFqnF58.js";import"./createLucideIcon-Dxxz6vIF.js";import"./triangle-alert-B4EEUfJ2.js";import"./arrow-left-BVXwwsEK.js";import"./index-Df7SgQj4.js";import"./index-DuD1r06n.js";import"./HomeIcon-C1Nmwbcs.js";import"./HeartIcon-DIsEUO4m.js";import"./ClockIcon-DwkVWySi.js";import"./ChatBubbleLeftRightIcon-DwQ8cfSI.js";import"./DocumentTextIcon-D60LO0_O.js";import"./EnvelopeIcon-nLUT1zLT.js";import"./ClipboardDocumentCheckIcon-ClCm5rM4.js";import"./Bars3Icon-Dm2vVNy6.js";const w={draft:{label:"Brouillon",color:"bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300"},active:{label:"Actif",color:"bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400"},deprecated:{label:"Obsolète",color:"bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400"}};function ae({workflows:m}){const i=m?.data||[],[a,o]=x.useState(null),c=()=>{a&&n.delete(route("workflows.destroy",a.uuid),{onSuccess:()=>{t.success("Workflow supprimé avec succès"),o(null)},onError:()=>{t.error("Erreur lors de la suppression")}})},p=r=>{n.post(route("workflows.duplicate",r.uuid),{},{onSuccess:()=>{t.success("Workflow dupliqué avec succès")},onError:()=>{t.error("Erreur lors de la duplication")}})},u=r=>{n.post(route("workflows.activate",r.uuid),{},{onSuccess:()=>{t.success("Workflow activé avec succès")},onError:()=>{t.error("Erreur lors de l'activation")}})};return e.jsxs(h,{children:[e.jsx(g,{title:"Workflows"}),e.jsx("div",{className:"py-6",children:e.jsxs("div",{className:"mx-auto px-4 sm:px-6 lg:px-8",children:[e.jsxs("div",{className:"flex items-center justify-between mb-6",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-2xl font-bold text-gray-900 dark:text-white",children:"Workflows"}),e.jsx("p",{className:"text-sm text-gray-500 dark:text-gray-400 mt-1",children:"Gérez vos workflows et automatisations"})]}),e.jsxs(s,{href:route("workflows.create"),className:`
