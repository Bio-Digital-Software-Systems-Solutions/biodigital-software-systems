import{R as u,j as e,H as g,L as s,a as n}from"./app-CWnYxekQ.js";import{D as h}from"./DashboardLayout-DqkazIIC.js";import{t}from"./index-CGRGTxn_.js";import{D as f}from"./delete-confirmation-dialog-D1RfHMDa.js";import{F as l}from"./PlusIcon-Bn3y3sQI.js";import{F as b}from"./PlayIcon-a6HWPlbo.js";import{F as y}from"./EyeIcon-Dm59UnGz.js";import{F as v}from"./PencilIcon-WD-mdxA1.js";import{F as j}from"./DocumentDuplicateIcon-C8Y2dYND.js";import{F as k}from"./TrashIcon-BWUMx950.js";import"./transition-yXymaHEI.js";import"./ChevronDownIcon-B6ezQIrh.js";import"./UserGroupIcon-CFuBcVGD.js";import"./PencilSquareIcon-Cvyu1FWq.js";import"./logger-BM3S30lt.js";import"./dialog-DXo53Jj_.js";import"./button-gmL7VX6W.js";import"./utils-DOYE-kNG.js";import"./badge-CV6Ovcd4.js";import"./shield-alert-CPcxDPKN.js";import"./createLucideIcon-Axi61dsf.js";import"./triangle-alert-JMB_FxGX.js";import"./arrow-left-CruOiSUH.js";import"./index-o9IOyFlQ.js";import"./HomeIcon-CpJu4eFg.js";import"./HeartIcon-CjJX5a3G.js";import"./ClockIcon-BqU5pq5v.js";import"./ChatBubbleLeftRightIcon-DHpXkIp6.js";import"./DocumentTextIcon-DG0BY8aj.js";import"./EnvelopeIcon-BeptLwdd.js";const w={draft:{label:"Brouillon",color:"bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300"},active:{label:"Actif",color:"bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400"},deprecated:{label:"Obsolète",color:"bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400"}};function ee({workflows:c}){const i=c?.data||[],[a,o]=u.useState(null),m=()=>{a&&n.delete(route("workflows.destroy",a.uuid),{onSuccess:()=>{t.success("Workflow supprimé avec succès"),o(null)},onError:()=>{t.error("Erreur lors de la suppression")}})},p=r=>{n.post(route("workflows.duplicate",r.uuid),{},{onSuccess:()=>{t.success("Workflow dupliqué avec succès")},onError:()=>{t.error("Erreur lors de la duplication")}})},x=r=>{n.post(route("workflows.activate",r.uuid),{},{onSuccess:()=>{t.success("Workflow activé avec succès")},onError:()=>{t.error("Erreur lors de l'activation")}})};return e.jsxs(h,{children:[e.jsx(g,{title:"Workflows"}),e.jsx("div",{className:"py-6",children:e.jsxs("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:[e.jsxs("div",{className:"flex items-center justify-between mb-6",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-2xl font-bold text-gray-900 dark:text-white",children:"Workflows"}),e.jsx("p",{className:"text-sm text-gray-500 dark:text-gray-400 mt-1",children:"Gérez vos workflows et automatisations"})]}),e.jsxs(s,{href:route("workflows.create"),className:`
