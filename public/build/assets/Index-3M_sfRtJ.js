import{R as u,j as e,H as g,L as s,a as n}from"./app-xxu7XukB.js";import{D as h}from"./DashboardLayout-Bjvl3HCO.js";import{t}from"./index-Jhea9q9w.js";import{D as f}from"./delete-confirmation-dialog-Cvog4Dbj.js";import{F as l}from"./PlusIcon-CscOgsHm.js";import{F as b}from"./PlayIcon-Cnr8CDBA.js";import{F as y}from"./EyeIcon-Bfl7w1RQ.js";import{F as v}from"./PencilIcon-o-tYEXXv.js";import{F as j}from"./DocumentDuplicateIcon-Dm0pQzmP.js";import{F as k}from"./TrashIcon-DnsmJIQC.js";import"./transition-DwUIYsqa.js";import"./ChevronDownIcon-D0Lq18DE.js";import"./UserGroupIcon-Do5P8VKT.js";import"./index-4vzl5C6y.js";import"./logger-BM3S30lt.js";import"./dialog-Dvv3IQ0V.js";import"./button-DWEeTRsh.js";import"./utils-DOYE-kNG.js";import"./badge-Cky0EK7c.js";import"./shield-alert-D7era-GE.js";import"./createLucideIcon-CPV3Np08.js";import"./triangle-alert-Dn4p_OSw.js";import"./arrow-left-2n0LLHvT.js";import"./index-C9gshAvh.js";import"./index-B1kCBeNb.js";import"./HomeIcon-BD8T6UUG.js";import"./HeartIcon-NBq2QD9F.js";import"./ClockIcon-CGyT9A2S.js";import"./ChatBubbleLeftRightIcon-Ycz8D6rX.js";import"./DocumentTextIcon-DVAno8b2.js";import"./EnvelopeIcon-B09-KYwc.js";import"./ClipboardDocumentCheckIcon-DqYQbZlP.js";import"./Bars3Icon-BYjZ3d7X.js";const w={draft:{label:"Brouillon",color:"bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300"},active:{label:"Actif",color:"bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400"},deprecated:{label:"Obsolète",color:"bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400"}};function se({workflows:m}){const i=m?.data||[],[a,o]=u.useState(null),c=()=>{a&&n.delete(route("workflows.destroy",a.uuid),{onSuccess:()=>{t.success("Workflow supprimé avec succès"),o(null)},onError:()=>{t.error("Erreur lors de la suppression")}})},p=r=>{n.post(route("workflows.duplicate",r.uuid),{},{onSuccess:()=>{t.success("Workflow dupliqué avec succès")},onError:()=>{t.error("Erreur lors de la duplication")}})},x=r=>{n.post(route("workflows.activate",r.uuid),{},{onSuccess:()=>{t.success("Workflow activé avec succès")},onError:()=>{t.error("Erreur lors de l'activation")}})};return e.jsxs(h,{children:[e.jsx(g,{title:"Workflows"}),e.jsx("div",{className:"py-6",children:e.jsxs("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:[e.jsxs("div",{className:"flex items-center justify-between mb-6",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-2xl font-bold text-gray-900 dark:text-white",children:"Workflows"}),e.jsx("p",{className:"text-sm text-gray-500 dark:text-gray-400 mt-1",children:"Gérez vos workflows et automatisations"})]}),e.jsxs(s,{href:route("workflows.create"),className:`
