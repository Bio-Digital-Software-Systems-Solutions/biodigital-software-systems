import{R as x,j as e,H as g,L as s,a as n}from"./app-CLwHgSIW.js";import{D as h}from"./DashboardLayout-JfDZs2uJ.js";import{t}from"./index-BVYR88sv.js";import{D as f}from"./delete-confirmation-dialog-B9hHnqT_.js";import{F as l}from"./PlusIcon-CLHkUwtQ.js";import{F as b}from"./PlayIcon-5cZGag6a.js";import{F as y}from"./EyeIcon-BHcdsfT0.js";import{F as v}from"./PencilIcon-BcMRnmMw.js";import{F as j}from"./DocumentDuplicateIcon-rCanPkvD.js";import{F as k}from"./TrashIcon-C_ZL01k_.js";import"./transition-C8P4HrMw.js";import"./ChevronDownIcon-LdvqeEmo.js";import"./UserGroupIcon-BwbUi7z7.js";import"./index-DOkc2KEQ.js";import"./toaster-BuvIjElm.js";import"./logger-BM3S30lt.js";import"./dialog-j7pVKpfI.js";import"./button-D78eQ79k.js";import"./utils-BAOgSzd2.js";import"./badge-CCdiwslG.js";import"./shield-alert-Ds7SQJnC.js";import"./createLucideIcon-DKYpvTUO.js";import"./triangle-alert-CRofrJg2.js";import"./arrow-left-BfCRuxbu.js";import"./index-D3rrnSXV.js";import"./index-CarQHiHF.js";import"./HomeIcon-CXgKk5Mo.js";import"./HeartIcon-gq85RNRR.js";import"./ClockIcon-Cz7KyHkP.js";import"./ChatBubbleLeftRightIcon-PjPffAgx.js";import"./DocumentTextIcon-DTAK20pw.js";import"./EnvelopeIcon-CgUFmGJf.js";import"./ClipboardDocumentCheckIcon-BizcMTMG.js";import"./Bars3Icon-BphJYp9E.js";const w={draft:{label:"Brouillon",color:"bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300"},active:{label:"Actif",color:"bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400"},deprecated:{label:"Obsolète",color:"bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400"}};function ae({workflows:m}){const i=m?.data||[],[a,o]=x.useState(null),c=()=>{a&&n.delete(route("workflows.destroy",a.uuid),{onSuccess:()=>{t.success("Workflow supprimé avec succès"),o(null)},onError:()=>{t.error("Erreur lors de la suppression")}})},p=r=>{n.post(route("workflows.duplicate",r.uuid),{},{onSuccess:()=>{t.success("Workflow dupliqué avec succès")},onError:()=>{t.error("Erreur lors de la duplication")}})},u=r=>{n.post(route("workflows.activate",r.uuid),{},{onSuccess:()=>{t.success("Workflow activé avec succès")},onError:()=>{t.error("Erreur lors de l'activation")}})};return e.jsxs(h,{children:[e.jsx(g,{title:"Workflows"}),e.jsx("div",{className:"py-6",children:e.jsxs("div",{className:"mx-auto px-4 sm:px-6 lg:px-8",children:[e.jsxs("div",{className:"flex items-center justify-between mb-6",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-2xl font-bold text-gray-900 dark:text-white",children:"Workflows"}),e.jsx("p",{className:"text-sm text-gray-500 dark:text-gray-400 mt-1",children:"Gérez vos workflows et automatisations"})]}),e.jsxs(s,{href:route("workflows.create"),className:`
