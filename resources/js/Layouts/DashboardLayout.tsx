...
export default function DashboardLayout({ children, title, description, actions }: DashboardLayoutProps) {
    ...
    const navigation: NavItem[] = [
        ...
        { name: 'Espace enseignant', href: '/teacher/dashboard', icon: ChartBarIcon, excludeRoles: [Role.MEMBER] },
        { name: 'Espace étudiant', href: '/student/dashboard', icon: UserCircleIcon, excludeRoles: [Role.MEMBER] },
        { name: t('chat'), href: '/chat', icon: ChatBubbleLeftRightIcon, permission: 'use chat' },
        { name: 'Projets', href: '/projects', icon: FolderIcon, permission: 'view programs' },
