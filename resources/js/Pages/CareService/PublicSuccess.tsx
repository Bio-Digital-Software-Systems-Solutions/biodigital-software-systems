...
export default function PublicSuccess({ action = 'booked', appointmentUuid }: Props) {
        ...
        switch (action) {
            case 'confirmed':
                return {
                    ...
                    description: 'Votre rendez-vous de care service a été confirmé avec succès.',
            ...
            case 'cancelled':
                return {
                    ...
                    description: 'Votre rendez-vous de care service a été annulé.',
            ...
            default: // 'booked'
                return {
                    ...
                    description: 'Votre demande de rendez-vous de care service a été transmise.',
    ...
    const handleBookAnother = () => {
        router.visit('/care-service/public/book');
    };
    ...
    return (
        <>
            <Head title={`${content.title} - Care Services`} />
