...
export default function Index({ availabilities, pastor }: Props) {
    const [deleteTarget, setDeleteTarget] = useState<CareServiceAvailability | null>(null);
    ...
    const handleToggleStatus = (availability: CareServiceAvailability) => {
        router.post(
            route('care-service-availability.toggle-status', availability.id),
            {},
            {
                preserveScroll: true,
                onSuccess: () => {
    ...
    const handleDelete = async () => {
        ...
        setIsDeleting(true);
        router.delete(
            route('care-service-availability.destroy', deleteTarget.id),
            {
                preserveScroll: true,
                onSuccess: () => {
    ...
    const getStatusBadge = (availability: CareServiceAvailability) => {
    ...
    // List View Component
    const renderAvailabilityList = (availability: CareServiceAvailability) => (
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2 pt-2 border-t">
                        <Button variant="outline" size="sm" asChild className="flex-1">
                            <Link href={route('care-service-availability.show', availability.id)}>
                        ...
                        <Button variant="outline" size="sm" asChild className="flex-1">
                            <Link href={route('care-service-availability.edit', availability.id)}>
    ...
    const renderAvailabilityCard = (availability: CareServiceAvailability) => (
    ...
    return (
        <DashboardLayout
            ...
            description="Gérez vos heures de disponibilité pour les consultations care service"
            actions={
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                    ...
                    <Button asChild className="w-full sm:w-auto">
                        <Link href={route('care-service-availability.create')}>
                        ...
                        {availabilities.length === 0 ? (
                            <Alert>
                                ...
                                <AlertDescription>
                                    ...
                                    <br />
                                    <Link
                                        href={route('care-service-availability.create')}
