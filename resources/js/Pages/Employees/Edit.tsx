...
export default function EmployeeEdit({
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        country: employee.country || 'Germany',
        ...
        working_days: employee.working_days || ['monday', 'tuesday', 'wednesday', 'thursday', 'friday'],
        default_start_time: employee.default_start_time || '09:00',
        default_end_time: employee.default_end_time || '17:00',
        annual_leave_days: employee.annual_leave_days?.toString() || '30',
        remaining_leave_days: employee.remaining_leave_days?.toString() || '30',
    ...
    return (
        <DashboardLayout>
            <Head title={`Modifier - ${employee.user?.name || employee.employee_number}`} />
            ...
            <div className="p-6 max-w-5xl mx-auto">
                    ...
                    <div className="flex items-center gap-4">
                        <Avatar className="h-16 w-16">
                            ...
                            <AvatarFallback className="text-xl bg-blue-100 text-blue-600">
                                {getInitials(employee.user?.name || 'NN')}
                            </AvatarFallback>
                        </Avatar>
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
                                Modifier {employee.user?.name}
                            </h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle>Utilisateur associé</CardTitle>
                            <CardDescription>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    <Label htmlFor="termination_date">Date de fin</Label>
                                    <Input
                                        id="termination_date"
                                        type="date"
                                ...
                                {data.termination_date && (
                                    <div className="md:col-span-3">
                                        <Label htmlFor="termination_reason">Raison de fin de contrat</Label>
                                        <Textarea
                                            id="termination_reason"
                                            value={data.termination_reason}
                                            onChange={(e) => setData('termination_reason', e.target.value)}
                                            rows={2}
                                        />
                                    </div>
                                )}
                        ...
                        <CardContent>
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <Label htmlFor="remaining_leave_days">Congés restants (jours)</Label>
                                        <Input
                                            id="remaining_leave_days"
                                            type="number"
                                            value={data.remaining_leave_days}
                                            onChange={(e) => setData('remaining_leave_days', e.target.value)}
                                        />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    <Label htmlFor="avatar">
                                        {employee.avatar ? 'Nouvelle photo' : 'Photo de profil'}
                                    </Label>
                                    <Input
                                        id="avatar"
                                        type="file"
                    ...
                    <div className="flex items-center justify-end gap-4">
                        <Button variant="outline" asChild>
                            <Link href={`/employees/${employee.uuid}`}>Annuler</Link>
                        </Button>
