...
export default function RoutineEdit({ department, routine, departmentUsers, frequencies }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        name: routine.name,
        description: routine.description ?? '',
        frequency: routine.frequency,
        responsible_id: routine.responsible_id ? String(routine.responsible_id) : '',
        estimated_duration_minutes: routine.estimated_duration_minutes ?? ('' as string | number),
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/departments/${department.uuid}/routines/${routine.uuid}`, {
            onSuccess: () => toast.success('Routine mise à jour'),
    ...
    return (
        <DashboardLayout>
            <Head title={`Modifier ${routine.name} - ${department.name}`} />
            ...
            <div className="mx-auto py-6 px-4 sm:px-6 lg:px-8">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Modifier la routine</h1>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <Select
                                    ...
                                    onValueChange={v => setData('responsible_id', v)}
                                >
                                    <SelectTrigger>
