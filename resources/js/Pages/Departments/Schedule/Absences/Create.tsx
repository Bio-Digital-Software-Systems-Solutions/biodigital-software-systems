...
export default function CreateAbsence({
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        interim_user_id: '' as string | number,
        interim_notes: '',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(`/departments/${department.uuid}/absences`, {
            forceFormData: true,
        });
    };
    ...
    return (
        <DashboardLayout>
            <Head title={`Nouvelle demande d'absence - ${department.name}`} />
                                ...
                                <div className="mt-4 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-sm text-green-800 dark:text-green-200">
                                            Ce type d'absence ne necessite pas d'approbation
                                        </span>
                                    </div>
                                </div>
                            )}
                            ...
                            {data.is_half_day && (
                                <div className="space-y-2">
                                    ...
                                    {errors.half_day_period && (
                                        <p className="text-sm text-red-600">{errors.half_day_period}</p>
                                    )}
                                </div>
                            )}
