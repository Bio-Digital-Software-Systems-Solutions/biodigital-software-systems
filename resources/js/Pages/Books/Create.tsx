...
interface CreateBookPageProps extends PageProps {
    categories: Category[];
    libraries: Library[];
}

export default function Create() {
    const { categories, libraries } = usePage<CreateBookPageProps>().props;
    ...
    return (
        <DashboardLayout>
            <Head title="Ajouter un livre - AIG-App" />
                ...
                <div className="mx-auto">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">
                            Ajoutez un livre à votre bibliothèque pour qu'il puisse être loué par les membres.
                        </p>
                    </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                                <div className="flex justify-end space-x-3">
                                    ...
                                    >
                                        {processing ? 'Ajout...' : 'Ajouter le livre'}
                                    </button>
                                </div>
                            </div>
                        </form>
