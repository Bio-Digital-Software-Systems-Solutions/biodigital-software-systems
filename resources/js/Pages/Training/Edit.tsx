...
export default function Edit({ training, teachers = [] }: Props) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('trainings.update', training.uuid), {
            forceFormData: true,
        });
    };
                                            ...
                                            <div className="text-center">
                                                ...
                                                {data.image && (
                                                    <p className="mt-2 text-sm text-gray-900 dark:text-white">
                                                        Fichier: <span className="font-medium">{typeof data.image === 'string' ? data.image : data.image.name}</span>
                                                    </p>
                                                )}
                                            </div>
                                        </div>
