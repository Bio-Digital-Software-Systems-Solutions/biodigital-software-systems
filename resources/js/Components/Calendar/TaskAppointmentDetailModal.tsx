...
export default function TaskAppointmentDetailModal({
    isOpen,
    onClose,
    onUpdate,
    onDelete,
    ...
    const handleSave = async (e: FormEvent) => {
        ...
        try {
            ...
            await axios.patch(`/api/tasks/${taskUuid}/appointments/${appointment.uuid}`, payload);
    ...
    const handleDeleteConfirm = async () => {
        ...
        try {
            await axios.delete(`/api/tasks/${taskUuid}/appointments/${appointment.uuid}`);
    ...
    const handleStatusChange = async (newStatus: AppointmentStatus) => {
        ...
        try {
            await axios.patch(`/api/tasks/${taskUuid}/appointments/${appointment.uuid}`, {
                status: newStatus
            });
