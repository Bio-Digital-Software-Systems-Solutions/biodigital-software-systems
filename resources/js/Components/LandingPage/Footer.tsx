...
const socialLinks = {
  social: [
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/elmarce-bounda-ndinga',
...
const Footer: React.FC = () => {
  ...
  const navigation = {
    services: [
      { name: t('home.footer.serviceMvp'), href: '#services' },
      { name: t('home.footer.serviceMiddleware'), href: '#services' },
      { name: t('home.footer.serviceSaas'), href: '#services' },
      { name: t('home.footer.serviceCustom'), href: '#services' },
    ],
    solutions: [
      { name: t('home.footer.industryBiotech'), href: '#solutions' },
      { name: t('home.footer.industryBioinformatics'), href: '#solutions' },
      { name: t('home.footer.industryLab'), href: '#solutions' },
      { name: t('home.footer.industryGenomics'), href: '#solutions' },
    ],
    company: [
      { name: t('home.footer.mission'), href: '#mission' },
      { name: t('home.footer.usp'), href: '#approach' },
      { name: t('home.footer.partners'), href: '#partners' },
      ...
      <div className="mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
                ...
                <ul role="list" className="mt-6 space-y-4">
                  {navigation.services.map((item) => (
                    <li key={item.name}>
                      <Link
                        href={item.href}
                        className="text-sm leading-6 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300 transition-colors"
                      >
                        {item.name}
                      </Link>
                    </li>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24 dark:border-white/10">
          <p className="text-sm leading-6 text-gray-600 dark:text-gray-400">
            &copy; {new Date().getFullYear()} Bio-Digital Engineering Solutions. {t('home.footer.copyright')}
          </p>
        </div>
      </div>
    </footer>
