...
const stepTypes: StepTypeItem[] = [
    ...
    {
        type: 'parallel_split',
        label: 'Division parallèle',
        description: 'Diviser en branches parallèles',
    ...
    {
        type: 'parallel_join',
        label: 'Jonction parallèle',
        description: 'Attendre toutes les branches',
        icon: <ArrowsPointingOutIcon className="h-5 w-5 rotate-180" />,
        color: 'bg-cyan-100 text-cyan-600 dark:bg-cyan-900/30 dark:text-cyan-400',
        category: 'logic',
    },
    {
    ...
    },
    {
        type: 'wait',
        label: 'Attente',
        description: 'Attendre un délai ou événement',
