...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Care Service System Configuration
    |--------------------------------------------------------------------------
    |
    | This file contains the configuration options for the care service
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Define when care service appointments are available.
    ...
    */
    ...
    'notifications' => [
        'enabled' => env('CARE_SERVICE_NOTIFICATIONS_ENABLED', true),

        // Email templates
        'templates' => [
            'appointment_confirmation' => 'emails.care-service.appointment-confirmation',
            'appointment_reminder' => 'emails.care-service.appointment-reminder',
            'appointment_cancellation' => 'emails.care-service.appointment-cancellation',
            'new_appointment_notification' => 'emails.care-service.new-appointment-notification',
        ],
    ...
    */
    ...
    'pastor_assignment' => [
        ...
        'availability' => [
            'default_hours_per_week' => 10, // Hours available for care service per week
    ...
    */
    ...
    'security' => [
        ...
        'encryption' => [
            'encrypt_personal_data' => env('ENCRYPT_CARE_SERVICE_DATA', true),
            'encryption_key' => env('CARE_SERVICE_ENCRYPTION_KEY'),
        ],
    ],
    ...
    */
    ...
    'data_retention' => [
        ...
        'auto_cleanup_enabled' => env('CARE_SERVICE_AUTO_CLEANUP', true),
    ],
