...
return [
     ...
     */
    'except' => [
        // DepartmentTodo has 3 BelongsTo relations (assignee, creator, completedBy) all
        // pointing to User. Eager loading produces 3 separate "select from users where in"
        // queries which the detector incorrectly flags as N+1.
        \App\Models\Scheduling\DepartmentTodo::class => [
